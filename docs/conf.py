...
htmlhelp_basename = 'BiomolecularStructuresdoc'
...
man_pages = [
    (master_doc, 'biomolecularstructures', u'BiomolecularStructures Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'BiomolecularStructures', u'BiomolecularStructures Documentation',
   author, 'BiomolecularStructures', 'One line description of project.',
   'Miscellaneous'),
]
